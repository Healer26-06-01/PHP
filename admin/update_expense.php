                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="expense_for" value="<?php echo $expense_for; ?>" placeholder="Nhập chi phí" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="expense_name" class="form-control" required>
                                                ...
                                                foreach ($expense_sel as $value_sel) { ?>
                                                    <option value="<?php echo $value_sel['id'] ?>"><?php echo $value_sel['expense_name'];
                                                                                                    $expense_sel = $value_sel['expense_name']; ?></option>
