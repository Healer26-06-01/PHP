                    ...
                    <div class="card-body">
                        <form action="operations/expense_category.php" method="post">
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="expense_name" placeholder="Nhập tên" required>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions">
                                ...
                                <a href="add_expense_category.php"><button type="button" class="btn btn-inverse">Cancel</button></a>
                            </div>
                        </form>
                    </div>
                </div>
