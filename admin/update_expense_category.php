                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $expense_name; ?>" name="expense_name" placeholder="Nhập tên">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="status" value="Active" <?php if ($row['status'] == "Active") {
                                                                                                    echo "checked";
                                                                                                } ?>> Active
                                            &nbsp; &nbsp;&nbsp;<input type="radio" name="status" value="Deactive" <?php if ($row['status'] == "Deactive") {
                                                                                                                        echo "checked";
                                                                                                                    } ?>>Deactive<br>
                                        </div>
                                    </div>
