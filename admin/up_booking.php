                        ...
                        <div class="form-validation">
                            <form action="operations/booking.php" method="post">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="state_id" onchange="tax();" class="form-control" required>
                                            ...
                                            foreach ($expense_sel1 as $abc) { ?>
                                                <option value="<?php echo $abc['id'] ?>"><?php echo $abc['state_name'];
                                                                                        $expense_sel1 = $abc['state_name']; ?></option>
                                    ...
                                    <div class="col-lg-6">
                                        <select name="package_id" id="package_id" onchange="calculate();" class="form-control" required>
                                            ...
                                            foreach ($success as $package) { ?>
                                                <option value="<?php echo $package['id'] ?>"><?php echo $package['pname'];
                                                                                            $success = $package['pname']; ?></option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" min="0" onchange="calculate();" onkeyup="calculate();" class="form-control" value="<?php echo $no_of_adults; ?>" id="no_of_adults" name="no_of_adults" placeholder="Nhập giá" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-email">No Of Children <span class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input type="number" min="0" onchange="calculate();" onkeyup="calculate();" class="form-control" value="<?php echo $no_of_children; ?>" id="no_of_children" name="no_of_children" placeholder="Nhập giá" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="total_amount" name="total_amount" placeholder="Nhập tổng số tiền" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control" id="advance_amount" min="0" name="adv_amount" placeholder="Nhập số tiền tạm ứng" required>
                                    </div>
                                </div>
                                <div class="form-group row">
