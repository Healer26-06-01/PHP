                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" data-placeholder="Choose a Traveller" tabindex="1" name="traveller_id" required>
                                                <option value=""> Chọn khách du lịch</option>
                                                <?php
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="package_id" id="package_id" onchange="calculate();" class="form-control custom-select" required>
                                                <option value=""> Chọn chỗ du lịch</option>
                                                <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="number" min="0" onchange="calculate();" onkeyup="calculate();" class="form-control" id="no_of_adults" name="no_of_adults" placeholder="Nhập giá" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="number" min="0" onchange="calculate();" onkeyup="calculate();" class="form-control" id="no_of_children" name="no_of_children" placeholder="Nhập giá" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" class="form-control" id="total_amount" name="total_amount" placeholder="Tỏng cộng" required >
                                        </div>
                                    </div>
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" class="form-control" id="taxprice1" name="tax" onkeyup="sum2()" placeholder="Nhập tiền thuế" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" class="form-control" id="ttt2" name="total" placeholder="Tổng tiền" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="number" class="form-control" id="advance_amount"  max="<?php echo $total; ?>" name="adv_amount" placeholder="Tiền tạm ứng" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
