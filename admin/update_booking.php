                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="traveller_id" class="form-control" required>
                                                ...
                                                foreach ($travellers as $value) { ?>
                                                    <option value="<?php echo $value['id'] ?>" <?php if ($value['id'] == $traveller_id) {
                                                                                                    echo "selected";
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <select name="state_id" class="form-control" required>
                                                ...
                                                <option value="Tinh Tien Giang" <?php if ($row['state_id'] == "Tỉnh Tiền Giang") {
                                                                                echo "selected";
                                                                            } ?>>Tỉnh Tiền Giang</option>
                                                <option value="Tinh Long An" <?php if ($row['state_id'] == "Tỉnh Long An") {
                                                                            echo "selected";
                                                                        } ?>>Tỉnh Long An</option>
                                                <option value="Tinh Bac Lieu" <?php if ($row['state_id'] == "Tỉnh Bạc Liêu") {
                                                                            echo "selected";
                                                                        } ?>>Tỉnh Bạc Liêu</option>
                                                <option value="Tinh Lam Dong" <?php if ($row['state_id'] == "Tỉnh Lâm Đồng") {
                                                                            echo "selected";
                                                                        } ?>>Tỉnh Lâm Đồng</option>
                                                <option value="Tinh Kien Giang" <?php if ($row['state_id'] == "Tỉnh Kiên Giang") {
                                                                        echo "selected";
                                                                    } ?>>Tỉnh Kiên Giang</option>
                                                <option value="Tinh Hau Giang" <?php if ($row['state_id'] == "Tỉnh Hậu Giang") {
                                                                            echo "selected";
                                                                        } ?>>Tỉnh Hậu Giang</option>
                                                <option value="Tinh Ben Tre" <?php if ($row['state_id'] == "Tỉnh Bến Tre") {
                                                                            echo "selected";
                                                                        } ?>>Tỉnh Bến Tre</option>
                                                <option value="Tinh Vinh Long" <?php if ($row['state_id'] == "Tỉnh Vĩnh Long") {
                                                                            echo "selected";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="package_id" id="package_id" onchange="calculate();" class="form-control" required>
                                                ...
                                                foreach ($packages as $value1) { ?>
                                                    <option value="<?php echo $value1['id'] . ',' . $value1['price_adult'] . ',' . $value1['price_children'] ?>" <?php if ($value1['id'] == $package_id) {
                                                                                                                                                            echo "selected";
                                                                                                                                                        } ?>><?php echo $value1['pname']; ?></option>
                                                <?php } ?>
