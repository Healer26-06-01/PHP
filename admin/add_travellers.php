                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="val-username" pattern="[a-zA-Z][a-zA-Z ]+" placeholder="Nhập tên" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="email" class="form-control" name="val-email" placeholder="Nhập địa chỉ email" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="txtPassword" class="form-control" name="val-password" title="Please Enter At least one alphabet,one alphabet in upper case,Special Character,Digit for Strong Password" placeholder="Nhập mật khẩu" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="password" id="txtConfirmPassword" class="form-control" name="val-confirm-password" placeholder="Nhập lại mật khẩu" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="tel" class="form-control" name="val-digits" placeholder="Nhập số điện thoại"maxlength="10" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="val-suggestions" rows="5" placeholder="Nhập địa chỉ" required></textarea>
                                        </div>
                                    </div>
