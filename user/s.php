                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <select name="state_name" class="form-control" required>
                                                ...
                                                <option value="Maharashtra" <?php if ($row1['state_name'] == "Maharashtra") {
                                                                                echo "selected";
                                                                            } ?>>Maharashtra</option>
                                                <option value="Gujrat" <?php if ($row1['state_name'] == "Gujrat") {
                                                                            echo "selected";
                                                                        } ?>>Gujrat</option>
                                                <option value="Delhi" <?php if ($row1['state_name'] == "Delhi") {
                                                                            echo "selected";
                                                                        } ?>>Delhi</option>
                                                <option value="Bihar" <?php if ($row1['state_name'] == "Bihar") {
                                                                            echo "selected";
                                                                        } ?>>Bihar</option>
                                                <option value="Goa" <?php if ($row1['state_name'] == "Goa") {
                                                                        echo "selected";
                                                                    } ?>>Goa</option>
                                                <option value="Punjab" <?php if ($row1['state_name'] == "Punjab") {
                                                                            echo "selected";
                                                                        } ?>>Punjab</option>
                                                <option value="Assam" <?php if ($row1['state_name'] == "Assam") {
                                                                            echo "selected";
                                                                        } ?>>Assam</option>
                                                <option value="Sikkim" <?php if ($row1['state_name'] == "Sikkim") {
                                                                            echo "selected";
                                                                        } ?>>Sikkim</option>
                                            </select>
